% source: RKF/NOTICE.md
\hypertarget{public-review-notice}{%
\chapter{Public Review Notice}\label{public-review-notice}}
...
a patent license;
a trademark license;
a right to represent modified results as certified by the author;
a right to reuse confidential or separately filed material;
a representation that any patent claim is valid, granted, infringed, or enforceable.
\end{verbatim}
...
\begin{flushright}\small\texttt{RKF/NOTICE.md}\end{flushright}
