% source: RKF/theorum/39_native_source_kernel_no_blindness_strict_odd.md
\hypertarget{native-source-kernel-no-blindness-and-strict-odd-cut-theorem}{%
\chapter{Native Source-Kernel No-Blindness and Strict Odd Cut Theorem}\label{native-source-kernel-no-blindness-and-strict-odd-cut-theorem}}
...
\hypertarget{abstract-cut-source-no-blindness-theorem}{%
\section{2. Abstract cut-source no-blindness theorem}\label{abstract-cut-source-no-blindness-theorem}}
...
\hypertarget{theorem-2.1-null-cut-source-injectivity}{%
\subsection{Theorem 2.1 (Null-cut source injectivity)}\label{theorem-2.1-null-cut-source-injectivity}}
...
\hypertarget{positive-measure-active-band-variant}{%
\section{3. Positive-measure active-band variant}\label{positive-measure-active-band-variant}}
...
\hypertarget{theorem-3.1-recognition-unique-active-observer}{%
\subsection{Theorem 3.1 (Recognition-unique active observer)}\label{theorem-3.1-recognition-unique-active-observer}}
...
\hypertarget{application-to-the-actual-completed-odd-source}{%
\section{4. Application to the actual completed odd source}\label{application-to-the-actual-completed-odd-source}}
...
\hypertarget{theorem-4.1-actual-source-kernel-no-blindness}{%
\subsection{Theorem 4.1 (Actual source-kernel no-blindness)}\label{theorem-4.1-actual-source-kernel-no-blindness}}
...
\hypertarget{independent-source-pin}{%
\subsection{Independent source pin}\label{independent-source-pin}}
...
\hypertarget{strict-odd-completed-weil-positivity}{%
\section{5. Strict odd completed-Weil positivity}\label{strict-odd-completed-weil-positivity}}
...
\hypertarget{theorem-5.1-strict-odd-cut-theorem}{%
\subsection{Theorem 5.1 (Strict odd cut theorem)}\label{theorem-5.1-strict-odd-cut-theorem}}
...
\hypertarget{injective-cut-covariance-bridge}{%
\section{6. Injective cut-covariance bridge}\label{injective-cut-covariance-bridge}}
...
\hypertarget{corollary-6.1-boundary-line-no-blindness}{%
\subsection{Corollary 6.1 (Boundary-line no-blindness)}\label{corollary-6.1-boundary-line-no-blindness}}
...
\hypertarget{exact-generalized-calibration}{%
\section{7. Exact generalized calibration}\label{exact-generalized-calibration}}
...
\hypertarget{noncoercive-strictness-calibration}{%
\section{8. Noncoercive strictness calibration}\label{noncoercive-strictness-calibration}}
...
\hypertarget{next-membrane}{%
\section{9. Next membrane}\label{next-membrane}}
...
\begin{flushright}\small\texttt{RKF/theorum/39\_native\_source\_kernel\_no\_blindness\_strict\_odd.md}\end{flushright}
