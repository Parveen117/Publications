% source: RKF/theorum/45_directed_arithmetic_analytic_closure_theorem.md
\hypertarget{directed-arithmetic-analytic-closure-theorem}{%
\chapter{Directed Arithmetic-Analytic Closure Theorem}\label{directed-arithmetic-analytic-closure-theorem}}

\hypertarget{purpose-and-source-lineage}{%
\section{1. Purpose and source lineage}\label{purpose-and-source-lineage}}
...
It does \textbf{not} assert that raw IEEE floating point becomes exact, that every
external numerical package is validated, or that a centre value without an
outward radius is proof-bearing.

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\hypertarget{exact-scalar-carrier}{%
\section{2. Exact scalar carrier}\label{exact-scalar-carrier}}
...
\hypertarget{validated-enclosure-carrier}{%
\section{3. Validated enclosure carrier}\label{validated-enclosure-carrier}}
...
A numerical backend is \textbf{validated for one result} only when it supplies an
...
\hypertarget{arithmetic-analytic-decomposition}{%
\section{4. Arithmetic-analytic decomposition}\label{arithmetic-analytic-decomposition}}
...
\hypertarget{theorem-4.1-total-enclosure}{%
\subsection{Theorem 4.1 (Total enclosure)}\label{theorem-4.1-total-enclosure}}
...
\hypertarget{lawful-correction-madhava-refinement}{%
\section{5. Lawful correction / Madhava refinement}\label{lawful-correction-madhava-refinement}}
...
\hypertarget{three-ledger-refinement-identity}{%
\section{6. Three-ledger refinement identity}\label{three-ledger-refinement-identity}}
...
\hypertarget{directed-precision-refinement-convergence}{%
\section{7. Directed precision-refinement convergence}\label{directed-precision-refinement-convergence}}
...
\hypertarget{theorem-7.1-arithmetic-analytic-convergence}{%
\subsection{Theorem 7.1 (Arithmetic-analytic convergence)}\label{theorem-7.1-arithmetic-analytic-convergence}}
...
\hypertarget{independent-path-enclosure-test}{%
\section{8. Independent-path enclosure test}\label{independent-path-enclosure-test}}
...
\hypertarget{theorem-8.1-certified-path-overlap-necessity}{%
\subsection{Theorem 8.1 (Certified path-overlap necessity)}\label{theorem-8.1-certified-path-overlap-necessity}}
...
\hypertarget{strict-outward-threshold-promotion}{%
\section{9. Strict outward threshold promotion}\label{strict-outward-threshold-promotion}}
...
\hypertarget{backend-classes}{%
\section{10. Backend classes}\label{backend-classes}}
...
\hypertarget{exact-finite-certificate}{%
\section{11. Exact finite certificate}\label{exact-finite-certificate}}

The accompanying proof packet uses only \texttt{fractions.Fraction} plus exact decimal
token conversion through \texttt{decimal.Decimal}. It verifies:
...
\begin{flushright}\small\texttt{RKF/theorum/45\_directed\_arithmetic\_analytic\_closure\_theorem.md}\end{flushright}
