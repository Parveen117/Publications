% source: RKF/theorum/36_native_prime_gamma_debt_source_adapter.md
\hypertarget{native-primegammadebt-source-adapter-and-graph-null-seam-theorem}{%
\chapter{Native Prime--Gamma--Debt Source Adapter and Graph-Null Seam Theorem}\label{native-primegammadebt-source-adapter-and-graph-null-seam-theorem}}
...
\hypertarget{primegamma-mismatch-and-debt-source}{%
\section{2. Prime--Gamma mismatch and debt source}\label{primegamma-mismatch-and-debt-source}}
...
\hypertarget{native-graph-carrier}{%
\section{3. Native graph carrier}\label{native-graph-carrier}}
...
\hypertarget{canonical-source-adapter-theorem}{%
\section{4. Canonical source-adapter theorem}\label{canonical-source-adapter-theorem}}

\hypertarget{theorem-4.1-canonical-native-source-adapter}{%
\subsection{Theorem 4.1 (Canonical native source adapter)}\label{theorem-4.1-canonical-native-source-adapter}}
...
\hypertarget{all-adapters-form-one-graph-null-affine-family}{%
\section{5. All adapters form one graph-null affine family}\label{all-adapters-form-one-graph-null-affine-family}}

\hypertarget{theorem-5.1-graph-null-adapter-classification}{%
\subsection{Theorem 5.1 (Graph-null adapter classification)}\label{theorem-5.1-graph-null-adapter-classification}}
...
\hypertarget{boundary-recognition-class-is-adapter-invariant}{%
\section{6. Boundary recognition class is adapter invariant}\label{boundary-recognition-class-is-adapter-invariant}}
...
\hypertarget{theorem-6.1-adapter-independent-quotient-decoder}{%
\subsection{Theorem 6.1 (Adapter-independent quotient decoder)}\label{theorem-6.1-adapter-independent-quotient-decoder}}
...
\hypertarget{canonical-minimum-decoder-after-a-relative-bound}{%
\section{7. Canonical minimum decoder after a relative bound}\label{canonical-minimum-decoder-after-a-relative-bound}}
...
\hypertarget{event-coordinate-covariance}{%
\section{8. Event-coordinate covariance}\label{event-coordinate-covariance}}
...
\hypertarget{robust-two-sheet-attachment-theorem}{%
\section{9. Robust two-sheet attachment theorem}\label{robust-two-sheet-attachment-theorem}}
...
\hypertarget{exact-stage-3d-calibration}{%
\section{10. Exact Stage 3D calibration}\label{exact-stage-3d-calibration}}
...
\hypertarget{actual-completed-weil-status}{%
\section{11. Actual completed-Weil status}\label{actual-completed-weil-status}}
...
\hypertarget{next-theorem-stage-3e}{%
\section{12. Next theorem: Stage 3E}\label{next-theorem-stage-3e}}
...
\begin{flushright}\small\texttt{RKF/theorum/36\_native\_prime\_gamma\_debt\_source\_adapter.md}\end{flushright}
