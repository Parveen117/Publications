% source: RKF/theorum/thermodynamics/lambda_geometry/11_noncommutative_holonomy_and_irreducibility.md
\hypertarget{noncommutative-holonomy-curvature-and-irreducibility}{%
\chapter{Noncommutative Holonomy, Curvature, and Irreducibility}\label{noncommutative-holonomy-curvature-and-irreducibility}}
...
\hypertarget{seam-dagger-lift}{%
\section{1. Seam-dagger lift}\label{seam-dagger-lift}}
...
\hypertarget{noncommutative-path-order-theorem}{%
\section{2. Noncommutative path-order theorem}\label{noncommutative-path-order-theorem}}
...
\hypertarget{spectral-shadow-collision-theorem}{%
\section{3. Spectral-shadow collision theorem}\label{spectral-shadow-collision-theorem}}
...
\hypertarget{small-square-curvature-theorem}{%
\section{4. Small-square curvature theorem}\label{small-square-curvature-theorem}}
...
\hypertarget{common-commutant-irreducibility-theorem}{%
\section{5. Common-commutant irreducibility theorem}\label{common-commutant-irreducibility-theorem}}
...
\hypertarget{three-distinct-notions}{%
\section{6. Three distinct notions}\label{three-distinct-notions}}
...
\hypertarget{nonmultiplicativity-of-local-factors}{%
\section{7. Nonmultiplicativity of local factors}\label{nonmultiplicativity-of-local-factors}}
...
\begin{flushright}\small\texttt{RKF/theorum/thermodynamics/lambda\_geometry/11\_noncommutative\_holonomy\_and\_irreducibility.md}\end{flushright}
