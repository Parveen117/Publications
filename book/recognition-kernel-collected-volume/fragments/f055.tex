% source: RKF/theorum/thermodynamics/04_projection_defect_and_source_overlap.md
\hypertarget{thermodynamic-projection-defect-and-source-overlap-theorems}{%
\chapter{Thermodynamic Projection-Defect and Source-Overlap Theorems}\label{thermodynamic-projection-defect-and-source-overlap-theorems}}

\hypertarget{projection-defect}{%
\section{1. Projection defect}\label{projection-defect}}
...
\hypertarget{theorem-1.1-thermodynamic-projection-defect}{%
\section{Theorem 1.1 (thermodynamic projection defect)}\label{theorem-1.1-thermodynamic-projection-defect}}
...
\hypertarget{thermodynamic-source-synthesis}{%
\section{2. Thermodynamic source synthesis}\label{thermodynamic-source-synthesis}}
...
\hypertarget{theorem-2.1-source-overlap-gram-identity}{%
\section{Theorem 2.1 (source-overlap Gram identity)}\label{theorem-2.1-source-overlap-gram-identity}}
...
\hypertarget{event-resolved-overlap}{%
\section{3. Event-resolved overlap}\label{event-resolved-overlap}}
...
\begin{flushright}\small\texttt{RKF/theorum/thermodynamics/04\_projection\_defect\_and\_source\_overlap.md}\end{flushright}
