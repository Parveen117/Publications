% source: RKF/theorum/21_cut_memory_spectral_isomorphism.md
\hypertarget{cut-memory-spectral-isomorphism-and-rank-five-fredholm-reduction}{%
\chapter{Cut-Memory Spectral Isomorphism and Rank-Five Fredholm Reduction}\label{cut-memory-spectral-isomorphism-and-rank-five-fredholm-reduction}}
...
The correct capstone is a \textbf{relative} spectral theorem.

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\hypertarget{native-cut-setup}{%
\section{1. Native cut setup}\label{native-cut-setup}}
...
\hypertarget{memory-cut-rank-hypothesis}{%
\subsection{Memory Cut Rank Hypothesis}\label{memory-cut-rank-hypothesis}}
...
\hypertarget{positive-spectrum-is-transport-zero-spectrum-is-memory}{%
\section{2. Positive spectrum is transport; zero spectrum is memory}\label{positive-spectrum-is-transport-zero-spectrum-is-memory}}

\hypertarget{theorem-2.1-cut-bridge-spectral-isomorphism}{%
\subsection{Theorem 2.1 (Cut-bridge spectral isomorphism)}\label{theorem-2.1-cut-bridge-spectral-isomorphism}}
...
\hypertarget{corollary-2.2-cut-generated-rotation-memory}{%
\subsection{Corollary 2.2 (Cut-generated rotation memory)}\label{corollary-2.2-cut-generated-rotation-memory}}
...
\hypertarget{the-exact-infinite-to-finite-theorem}{%
\section{3. The exact infinite-to-finite theorem}\label{the-exact-infinite-to-finite-theorem}}
...
\hypertarget{theorem-3.1-cut-memory-birmanschwingerfredholm-isomorphism}{%
\subsection{Theorem 3.1 (Cut-memory Birman--Schwinger--Fredholm isomorphism)}\label{theorem-3.1-cut-memory-birmanschwingerfredholm-isomorphism}}

The following identities hold.

\hypertarget{normalized-factorization}{%
\subsubsection{Normalized factorization}\label{normalized-factorization}}
...
\hypertarget{shared-nonzero-spectrum}{%
\subsubsection{Shared nonzero spectrum}\label{shared-nonzero-spectrum}}
...
\hypertarget{exact-inertia-reduction}{%
\subsubsection{Exact inertia reduction}\label{exact-inertia-reduction}}
...
\hypertarget{exact-relative-gap}{%
\subsubsection{Exact relative gap}\label{exact-relative-gap}}
...
\hypertarget{fredholm-determinant-isomorphism}{%
\subsubsection{Fredholm determinant isomorphism}\label{fredholm-determinant-isomorphism}}
...
\hypertarget{the-determinant-warning}{%
\section{4. The determinant warning}\label{the-determinant-warning}}

\hypertarget{proposition-4.1}{%
\subsection{Proposition 4.1}\label{proposition-4.1}}
...
does \textbf{not} imply \(B<I\) or \(F>0\).

\hypertarget{exact-counterexample}{%
\subsubsection{Exact counterexample}\label{exact-counterexample}}
...
\hypertarget{the-actual-infinite-to-finite-animal}{%
\section{5. The actual infinite-to-finite animal}\label{the-actual-infinite-to-finite-animal}}
...
\hypertarget{rh-specialization-and-the-genuine-next-theorem}{%
\section{6. RH specialization and the genuine next theorem}\label{rh-specialization-and-the-genuine-next-theorem}}
...
\hypertarget{targeted-theorem-memory-cut-rank-and-source-defect-identification}{%
\subsection{Targeted Theorem (Memory Cut Rank and Source-Defect Identification)}\label{targeted-theorem-memory-cut-rank-and-source-defect-identification}}
...
\hypertarget{numerical-certificate-v0.1}{%
\section{7. Numerical certificate v0.1}\label{numerical-certificate-v0.1}}

The executable packet checks four independent cases.

\hypertarget{cut-bridge-calibration}{%
\subsection{Cut-bridge calibration}\label{cut-bridge-calibration}}
...
\hypertarget{exact-subcritical-five-memory-packet}{%
\subsection{Exact subcritical five-memory packet}\label{exact-subcritical-five-memory-packet}}
...
\hypertarget{threshold-packet}{%
\subsection{Threshold packet}\label{threshold-packet}}
...
\hypertarget{positive-determinant-negative-control}{%
\subsection{Positive-determinant negative control}\label{positive-determinant-negative-control}}
...
\section{8. Claim boundary}\label{claim-boundary}}
...
\begin{flushright}\small\texttt{RKF/theorum/21\_cut\_memory\_spectral\_isomorphism.md}\end{flushright}
