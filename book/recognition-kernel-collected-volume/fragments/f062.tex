% source: RKF/theorum/thermodynamics/10_thermodynamic_cut_square_response_decomposition.md
\hypertarget{thermodynamic-cut-square-response-decomposition-theorem}{%
\chapter{Thermodynamic Cut-Square Response Decomposition Theorem}\label{thermodynamic-cut-square-response-decomposition-theorem}}
...
\tightlist
\item
  energy captured by a declared scalar response channel;
\item
  unused contractive reserve;
\item
  pairwise transverse response squares.
\end{enumerate}
...
\hypertarget{typed-thermodynamic-response-fibre}{%
\section{2. Typed thermodynamic response fibre}\label{typed-thermodynamic-response-fibre}}
...
\hypertarget{exact-thermodynamic-cut-square-identity}{%
\section{3. Exact thermodynamic cut-square identity}\label{exact-thermodynamic-cut-square-identity}}

\hypertarget{theorem-3.1}{%
\subsection{Theorem 3.1}\label{theorem-3.1}}

For every thermodynamic response event \texttt{y} and decoder \texttt{c},
...
\hypertarget{contractive-response-decomposition}{%
\section{4. Contractive response decomposition}\label{contractive-response-decomposition}}
...
to both sides of Theorem 3.1. Every term on the right is nonnegative when \texttt{beta\_th\ \textless{}=\ 1}. The operator statement is the same quadratic-form identity because
...
\hypertarget{four-channel-thermodynamic-tetrad}{%
\section{5. Four-channel thermodynamic tetrad}\label{four-channel-thermodynamic-tetrad}}
...
The \texttt{(p,v)} and \texttt{(s,t)} minors measure mismatch within the caloric and mechanical pairs. The remaining four minors measure cross-pair incompatibility. These names are interpretive labels only; the rigorous content is the positive metric-square decomposition.

\hypertarget{equality-and-no-leakage-classification}{%
\section{6. Equality and no-leakage classification}\label{equality-and-no-leakage-classification}}

\hypertarget{corollary-6.1}{%
\subsection{Corollary 6.1}\label{corollary-6.1}}
...
\hypertarget{sharp-thermodynamic-decoder-burden}{%
\section{7. Sharp thermodynamic decoder burden}\label{sharp-thermodynamic-decoder-burden}}

Suppose a declared scalar response functional \texttt{ell} admits at least one representation
...
\hypertarget{onsager-entropy-production-specialization}{%
\section{8. Onsager entropy-production specialization}\label{onsager-entropy-production-specialization}}
...
\hypertarget{relation-to-flat-caloric-mechanical-closure}{%
\section{9. Relation to flat caloric-mechanical closure}\label{relation-to-flat-caloric-mechanical-closure}}
...
\hypertarget{interface-with-the-thermodynamic-response-cost}{%
\section{10. Interface with the thermodynamic response cost}\label{interface-with-the-thermodynamic-response-cost}}

Let a source state \texttt{x} produce the thermodynamic response
...
Pointwise on \texttt{x}, its defect is exactly the contractive reserve plus the thermodynamic cut-square residue of \texttt{Bx}.

This theorem controls extraction of one rank-one response channel from \texttt{Q\_th}. The nonlinear barrier

\[
W_{\rm th}=I-e^{-Q_{\rm th}}
\]

remains the separate functional-calculus construction proved in the canonical response-cost capsule. No unproved commutation or direct identification between the rank-one cut defect and \texttt{W\_th} is assumed here.
...
\begin{flushright}\small\texttt{RKF/theorum/thermodynamics/10\_thermodynamic\_cut\_square\_response\_decomposition.md}\end{flushright}
