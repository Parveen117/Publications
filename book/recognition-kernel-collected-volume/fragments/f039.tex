% source: RKF/theorum/37_native_two_sheet_hardy_compatibility_attachment.md
\hypertarget{native-two-sheet-hardy-boundary-and-compatibility-transfer-theorem}{%
\chapter{Native Two-Sheet Hardy Boundary and Compatibility-Transfer Theorem}\label{native-two-sheet-hardy-boundary-and-compatibility-transfer-theorem}}
...
\hypertarget{native-two-sheet-hardy-chart}{%
\section{2. Native two-sheet Hardy chart}\label{native-two-sheet-hardy-chart}}
...
\hypertarget{strip-cauchy-boundary-density}{%
\section{3. Strip Cauchy boundary density}\label{strip-cauchy-boundary-density}}
...
\hypertarget{theorem-3.1-exact-strip-boundary-first-moment}{%
\subsection{Theorem 3.1 (Exact strip boundary first moment)}\label{theorem-3.1-exact-strip-boundary-first-moment}}
...
\hypertarget{compatibility-displacement-of-the-source-chart}{%
\section{4. Compatibility displacement of the source chart}\label{compatibility-displacement-of-the-source-chart}}
...
\hypertarget{compatibility-transfer-theorem}{%
\section{5. Compatibility-transfer theorem}\label{compatibility-transfer-theorem}}

\hypertarget{theorem-5.1-boundary-transfer-through-the-source-defect}{%
\subsection{Theorem 5.1 (Boundary transfer through the source defect)}\label{theorem-5.1-boundary-transfer-through-the-source-defect}}
...
\tightlist
\item
  \(b\in\operatorname{Ran}C^*\) on the positive support;
\item
  there exists a minimum-norm density
  \[
...
\hypertarget{zero-remembers-the-compatibility-cut}{%
\section{6. Zero remembers the compatibility cut}\label{zero-remembers-the-compatibility-cut}}
...
\hypertarget{corollary-6.1-zero-cut-support-gate}{%
\subsection{Corollary 6.1 (Zero-cut support gate)}\label{corollary-6.1-zero-cut-support-gate}}
...
\hypertarget{robust-source-loss-and-boundary-residual-theorem}{%
\section{7. Robust source-loss and boundary-residual theorem}\label{robust-source-loss-and-boundary-residual-theorem}}
...
\hypertarget{exact-generalized-calibrations}{%
\section{8. Exact generalized calibrations}\label{exact-generalized-calibrations}}
...
\hypertarget{actual-completed-weil-gate}{%
\section{9. Actual completed-Weil gate}\label{actual-completed-weil-gate}}
...
\begin{flushright}\small\texttt{RKF/theorum/37\_native\_two\_sheet\_hardy\_compatibility\_attachment.md}\end{flushright}
