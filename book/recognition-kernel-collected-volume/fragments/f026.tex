% source: RKF/theorum/24_clock_free_recognition_seam_cut_calculus.md
\hypertarget{clock-free-recognition-seam-cut-calculus}{%
\chapter{Clock-Free Recognition-Seam Cut Calculus}\label{clock-free-recognition-seam-cut-calculus}}
...
\hypertarget{recognition-objects}{%
\section{2. Recognition objects}\label{recognition-objects}}
...
\hypertarget{declared-transition-arrows}{%
\section{3. Declared transition arrows}\label{declared-transition-arrows}}
...
\hypertarget{definition-4.1-transition-differential-of-the-cut}{%
\subsection{Definition 4.1 (Transition differential of the cut)}\label{definition-4.1-transition-differential-of-the-cut}}
...
\hypertarget{exact-composition-residues}{%
\section{5. Exact composition residues}\label{exact-composition-residues}}

Block multiplication gives the clock-free chain law.

\hypertarget{theorem-5.1-composition-residue-identities}{%
\subsection{Theorem 5.1 (Composition-residue identities)}\label{theorem-5.1-composition-residue-identities}}
...
\hypertarget{cut-generated-forms}{%
\section{6. Cut-generated forms}\label{cut-generated-forms}}
...
\hypertarget{theorem-6.1-native-cut-decomposition}{%
\subsection{Theorem 6.1 (Native cut decomposition)}\label{theorem-6.1-native-cut-decomposition}}
...
\hypertarget{clock-free-differential-of-a-form}{%
\section{7. Clock-free differential of a form}\label{clock-free-differential-of-a-form}}

Let \(G_x\) be any form assigned to the object \(x\).

\hypertarget{definition-7.1-transition-differential}{%
\subsection{Definition 7.1 (Transition differential)}\label{definition-7.1-transition-differential}}
...
\hypertarget{theorem-7.2-clock-free-chain-rule}{%
\subsection{Theorem 7.2 (Clock-free chain rule)}\label{theorem-7.2-clock-free-chain-rule}}
...
\hypertarget{generated-ledgers-and-local-closure}{%
\section{8. Generated ledgers and local closure}\label{generated-ledgers-and-local-closure}}
...
\hypertarget{stable-repair-without-a-clock}{%
\section{9. Stable repair without a clock}\label{stable-repair-without-a-clock}}
...
\hypertarget{target-relevant-memory-and-finite-reduction}{%
\section{10. Target-relevant memory and finite reduction}\label{target-relevant-memory-and-finite-reduction}}
...
\hypertarget{definition-10.1-target-faithfulness}{%
\subsection{Definition 10.1 (Target faithfulness)}\label{definition-10.1-target-faithfulness}}
...
\hypertarget{generalized-exact-examples}{%
\section{11. Generalized exact examples}\label{generalized-exact-examples}}

The first executable stage contains three independent examples.

\hypertarget{example-a-nonlinear-seam-holonomy}{%
\subsection{Example A: nonlinear seam holonomy}\label{example-a-nonlinear-seam-holonomy}}
...
\hypertarget{example-b-target-blind-stable-repair}{%
\subsection{Example B: target-blind stable repair}\label{example-b-target-blind-stable-repair}}
...
\hypertarget{example-c-cut-generated-five-memory-packet}{%
\subsection{Example C: cut-generated five-memory packet}\label{example-c-cut-generated-five-memory-packet}}
...
\hypertarget{rh-as-a-specialization}{%
\section{12. RH as a specialization}\label{rh-as-a-specialization}}
...
\hypertarget{stage-boundary}{%
\section{13. Stage boundary}\label{stage-boundary}}
...
\begin{flushright}\small\texttt{RKF/theorum/24\_clock\_free\_recognition\_seam\_cut\_calculus.md}\end{flushright}
