% source: RKF/theorum/43_bilateral_jet_flow_recognition_capstone_theorem.md
\hypertarget{bilateral-jet-flow-recognition-capstone-theorem}{%
\chapter{Bilateral Jet-Flow Recognition Capstone Theorem}\label{bilateral-jet-flow-recognition-capstone-theorem}}

\hypertarget{status-and-purpose}{%
\section{1. Status and purpose}\label{status-and-purpose}}
...
\texttt{proof\_lab/bilateral\_jet\_flow\_capstone.py} verifies a finite nilpotent model and
...
The term \emph{bilateral strands} is used deliberately. A physical double-helical
...
\hypertarget{native-data}{%
\section{2. Native data}\label{native-data}}
...
\hypertarget{bilateral-flow-and-strand-closure}{%
\section{3. Bilateral flow and strand closure}\label{bilateral-flow-and-strand-closure}}

\hypertarget{theorem-3.1-bilateral-cut-conjugacy}{%
\subsection{Theorem 3.1 (Bilateral cut conjugacy)}\label{theorem-3.1-bilateral-cut-conjugacy}}
...
\hypertarget{alternating-cut-parity-of-the-jet-tower}{%
\section{4. Alternating cut parity of the jet tower}\label{alternating-cut-parity-of-the-jet-tower}}

\hypertarget{theorem-4.1-jet-parity-ladder}{%
\subsection{Theorem 4.1 (Jet parity ladder)}\label{theorem-4.1-jet-parity-ladder}}
...
\hypertarget{finite-jet-reconstruction-and-remainder}{%
\section{5. Finite jet reconstruction and remainder}\label{finite-jet-reconstruction-and-remainder}}

\hypertarget{theorem-5.1-observed-flow-jet-formula}{%
\subsection{Theorem 5.1 (Observed-flow jet formula)}\label{theorem-5.1-observed-flow-jet-formula}}
...
\hypertarget{bilateral-even-and-odd-response-strands}{%
\section{6. Bilateral even and odd response strands}\label{bilateral-even-and-odd-response-strands}}
...
\hypertarget{theorem-6.1-bilateral-strand-reconstruction}{%
\subsection{Theorem 6.1 (Bilateral strand reconstruction)}\label{theorem-6.1-bilateral-strand-reconstruction}}
...
\hypertarget{recognition-kernels-and-first-repair-order}{%
\section{7. Recognition kernels and first repair order}\label{recognition-kernels-and-first-repair-order}}
...
\hypertarget{theorem-7.1-monotone-blindness-reduction}{%
\subsection{Theorem 7.1 (Monotone blindness reduction)}\label{theorem-7.1-monotone-blindness-reduction}}
...
\hypertarget{decoder-burden-and-admissibility}{%
\section{8. Decoder burden and admissibility}\label{decoder-burden-and-admissibility}}
...
\hypertarget{seam-curvature-consumed-by-the-jet-observer}{%
\section{9. Seam curvature consumed by the jet observer}\label{seam-curvature-consumed-by-the-jet-observer}}
...
\hypertarget{capstone-classification}{%
\section{10. Capstone classification}\label{capstone-classification}}
...
\section{11. Exact rational certificate}\label{exact-rational-certificate}}
...
\hypertarget{analytic-and-physical-claim-boundary}{%
\section{12. Analytic and physical claim boundary}\label{analytic-and-physical-claim-boundary}}
...
\begin{flushright}\small\texttt{RKF/theorum/43\_bilateral\_jet\_flow\_recognition\_capstone\_theorem.md}\end{flushright}
