% source: RKF/theorum/38_native_compatibility_form_range_source_domination.md
\hypertarget{native-compatibility-form-range-and-t21-cut-source-domination-theorem}{%
\chapter{Native Compatibility Form-Range and T21 Cut-Source Domination Theorem}\label{native-compatibility-form-range-and-t21-cut-source-domination-theorem}}
...
hypothesis. The correct native object is the inverse-half \textbf{form range} of the
...
\hypertarget{correction-of-the-stage-3e-ambient-range-gate}{%
\section{2. Correction of the Stage 3E ambient-range gate}\label{correction-of-the-stage-3e-ambient-range-gate}}
...
\hypertarget{abstract-form-range-decoder-theorem}{%
\section{3. Abstract form-range decoder theorem}\label{abstract-form-range-decoder-theorem}}
...
\hypertarget{theorem-3.1-inverse-half-form-range-transfer}{%
\subsection{Theorem 3.1 (Inverse-half form-range transfer)}\label{theorem-3.1-inverse-half-form-range-transfer}}
...
\tightlist
\item
  \(L_b\) is bounded for the source seminorm \(f\mapsto\|Tf\|\);
\item
  \(b\in\operatorname{Dom}(S^{\dagger/2})\);
\item
  there exists a unique minimum-norm decoder
  \[
...
so \(b\in\operatorname{Ran}S^{1/2} =\operatorname{Dom}(S^{\dagger/2})\). Orthogonal projection of \(c\) onto
...
\hypertarget{corollary-3.2-cut-covariance}{%
\subsection{Corollary 3.2 (Cut covariance)}\label{corollary-3.2-cut-covariance}}
...
\hypertarget{exact-completed-two-sheet-source-symbol}{%
\section{4. Exact completed two-sheet source symbol}\label{exact-completed-two-sheet-source-symbol}}
...
\hypertarget{t21-as-a-loewner-lower-chart}{%
\section{5. T21 as a Loewner lower chart}\label{t21-as-a-loewner-lower-chart}}
...
\hypertarget{boundary-recognition-class-in-the-same-chart}{%
\section{6. Boundary recognition class in the same chart}\label{boundary-recognition-class-in-the-same-chart}}
...
\hypertarget{cellwise-form-domain-theorem}{%
\section{7. Cellwise form-domain theorem}\label{cellwise-form-domain-theorem}}
...
\hypertarget{actual-direct-unshifted-attachment}{%
\section{8. Actual direct-unshifted attachment}\label{actual-direct-unshifted-attachment}}
...
\section{9. Exact executable calibrations}\label{exact-executable-calibrations}}
...
\hypertarget{next-theorem}{%
\section{10. Next theorem}\label{next-theorem}}
...
\begin{flushright}\small\texttt{RKF/theorum/38\_native\_compatibility\_form\_range\_source\_domination.md}\end{flushright}
