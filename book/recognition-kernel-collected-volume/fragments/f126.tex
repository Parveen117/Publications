% source: RKF/theorum/MP_CLEANUP_CANDIDATES.md
\hypertarget{mp-cleanup-candidates-after-theorum-transfer}{%
\chapter{MP cleanup candidates after theorum transfer}\label{mp-cleanup-candidates-after-theorum-transfer}}

The theorem capsules have been moved into \texttt{Parveen117/Recognition-Kernel-Framework/theorum} on branch \texttt{agent/transfer-certified-theorum-from-mp}.
...
\hypertarget{safe-deletion-class}{%
\section{Safe deletion class}\label{safe-deletion-class}}
...
\hypertarget{do-not-delete-without-archival-copy}{%
\section{Do not delete without archival copy}\label{do-not-delete-without-archival-copy}}
...
\hypertarget{candidate-mp-prs-and-files}{%
\section{Candidate MP PRs and files}\label{candidate-mp-prs-and-files}}

\hypertarget{pr-246-branch-agentrh-rotation-metric-topology-reset}{%
\subsection{\texorpdfstring{PR \#246, branch \texttt{agent/rh-rotation-metric-topology-reset}}{PR \#246, branch agent/rh-rotation-metric-topology-reset}}\label{pr-246-branch-agentrh-rotation-metric-topology-reset}}
...
\hypertarget{pr-200-stack}{%
\subsection{PR \#200 stack}\label{pr-200-stack}}
...
\hypertarget{pr-242247254255277}{%
\subsection{PR \#242/\#247/\#254/\#255/\#277}\label{pr-242247254255277}}
...
\hypertarget{cleanup-rule}{%
\section{Cleanup rule}\label{cleanup-rule}}
...
\begin{flushright}\small\texttt{RKF/theorum/MP\_CLEANUP\_CANDIDATES.md}\end{flushright}
