% source: RKF/theorum/40_odd_native_classical_normalization_interface.md
\hypertarget{odd-native-to-classical-completed-weil-normalization-interface}{%
\chapter{Odd Native-to-Classical Completed-Weil Normalization Interface}\label{odd-native-to-classical-completed-weil-normalization-interface}}
...
\hypertarget{pinned-conventions}{%
\section{2. Pinned conventions}\label{pinned-conventions}}
...
\hypertarget{correlation-theorem}{%
\section{3. Correlation theorem}\label{correlation-theorem}}
...
\hypertarget{the-pinned-completed-explicit-formula-distribution}{%
\section{4. The pinned completed explicit-formula distribution}\label{the-pinned-completed-explicit-formula-distribution}}
...
\hypertarget{termwise-normalization-theorem}{%
\section{5. Termwise normalization theorem}\label{termwise-normalization-theorem}}
...
\hypertarget{theorem-5.1-exact-nativeclassical-distribution-interface}{%
\subsection{Theorem 5.1 (Exact native/classical distribution interface)}\label{theorem-5.1-exact-nativeclassical-distribution-interface}}
...
\hypertarget{hermitian-and-reflection-covariance}{%
\section{6. Hermitian and reflection covariance}\label{hermitian-and-reflection-covariance}}
...
\hypertarget{exact-odd-restriction}{%
\section{7. Exact odd restriction}\label{exact-odd-restriction}}
...
\hypertarget{theorem-7.1-odd-negative-rank-one-normalization}{%
\subsection{Theorem 7.1 (Odd negative-rank-one normalization)}\label{theorem-7.1-odd-negative-rank-one-normalization}}
...
\hypertarget{multiplicativelogarithmic-unitary-interface}{%
\section{8. Multiplicative/logarithmic unitary interface}\label{multiplicativelogarithmic-unitary-interface}}
...
\hypertarget{theorem-8.1}{%
\subsection{Theorem 8.1}\label{theorem-8.1}}
...
\hypertarget{fourier-sign-convention-invariance}{%
\section{9. Fourier-sign convention invariance}\label{fourier-sign-convention-invariance}}
...
\hypertarget{core-density-and-extension}{%
\section{10. Core density and extension}\label{core-density-and-extension}}
...
\section{11. Classical membrane}\label{classical-membrane}}
...
\hypertarget{executable-exact-packet}{%
\section{12. Executable exact packet}\label{executable-exact-packet}}
...
\begin{flushright}\small\texttt{RKF/theorum/40\_odd\_native\_classical\_normalization\_interface.md}\end{flushright}
