% source: Publications/papers/cut-first-equivalence/LINEAGE.md
\hypertarget{lineage-cut-first-equivalence}{%
\chapter{Lineage --- Cut-First Equivalence}\label{lineage-cut-first-equivalence}}
...
\hypertarget{what-is-new-here-vs.-the-paper}{%
\section{What is new here vs.~the paper}\label{what-is-new-here-vs.-the-paper}}

Nothing mathematically new is \emph{claimed}. What is added is:
...
\hypertarget{relationship-to-prior-capsules}{%
\section{Relationship to prior capsules}\label{relationship-to-prior-capsules}}

\begin{itemize}
\tightlist
\item
  The classical substrate (Stokes, contact-form Maxwell, Onsager in the
  reversible limit) is a \textbf{pinned named dependency}, cited and not
  rederived --- the same discipline used in the Λ-seam and Yang--Mills
  capsules.
\item
  The downstream quantization of the residue lives in
  \texttt{../lambda-seam-calibration/}: LAM-1/LAM-2's seam integers and
...
\hypertarget{cfe-2-addendum}{%
\section{CFE-2 addendum}\label{cfe-2-addendum}}
...
\hypertarget{cfe-q-addendum}{%
\section{CFE-Q addendum}\label{cfe-q-addendum}}
...
\begin{flushright}\small\texttt{Publications/papers/cut-first-equivalence/LINEAGE.md}\end{flushright}
